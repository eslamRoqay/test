...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-header">
            ...
            <a href="{{route('shifts.create')}}" class="btn btn-sm btn-light-success font-weight-bolder mr-2">
                <i class="fa fa-plus"></i>اضـافـه</a>
            @endcan
        </div>
        </div>
        <form action="{{ route('shifts.deletes') }}" method="post" id="delete-form">
            @csrf
            @can('delete-shifts')
