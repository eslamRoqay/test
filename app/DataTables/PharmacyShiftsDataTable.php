...
class PharmacyShiftsDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('User', function (Shift $shift) {
    ...
    {
        $key = $this->key;
        return $model->newQuery()->where('pharmacy_id',$key)->with('User');
    }
    ...
    {
        return $this->builder()
                    ->setTableId('pharmacyshifts-table')
    ...
    protected function getColumns()
    {
        return [
            Column::make('id')
                ...
                ->orderable(false)
                ->width(30),
            Column::make('User')->name('User.name')->title('اسم الموظف'),
    ...
    {
        return 'PharmacyShifts_' . date('YmdHis');
    }
}
